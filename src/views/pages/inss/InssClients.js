        ...
        <Row>
          ...
          <Col md="12">
            <Card className="strpied-tabled-with-hover">
              <Card.Header>
                <Card.Title as="h4">Tabela de Clientes INSS</Card.Title>
                   ...
                   clients.map((element,index)=>{
                    return(
                      ...
                      <tr key={index}>
                        ...
                        <td>{element.esp}</td>
                        <td>{element.bancopagto}</td>
                        <td>
                               <a href={'/admin/inss/edit/' + element.id}  className="btn btn-primary" id="btn-enterprise-edit" >EDITAR</a>|
                               <a href={'/admin/inss/view/' + element.id} className="btn btn-warning" id="btn-enterprise-warning">VER</a>|
                               <a  href={"/admin/inss/delete/" + element.id} className="btn btn-danger" id="btn-enterprise-danger" >DELETAR</a></td>
                      </tr>
